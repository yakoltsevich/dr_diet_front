...
export const Header2 = () => {
    return (
        <Navbar maxWidth='full'>
            <NavbarBrand>
                <AcmeLogo/>
                <p className="font-bold text-inherit text-red-400 sm:text-green-500 ">ACME</p>
            </NavbarBrand>

            <NavbarContent className="bg-red-400 sm:bg-green-500 sm:flex gap-4" justify="center">
                <NavbarItem>
